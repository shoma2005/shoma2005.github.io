...
#### 使い方
1. **A地点を設定**: 繰り返したい区間の開始位置で**Aボタン**をクリック
2. **B地点を設定**: 繰り返したい区間の終了位置で**Bボタン**をクリック
...
メニューバーの**再生速度**から選択します（0.25倍速～2.0倍速）。
...
**Fキー**または**F11キー**で全画面表示に切り替えます。

- タスクバーとウィンドウフレームが完全に隠れます
- 画面上部にマウスを移動すると解除ボタンが表示されます
- 再度**F**または**F11**キーで通常表示に戻ります
